...
struct Palette: Equatable {
    ...
    static let twilight = Palette(id: "twilight", name: "Twilight", stops: [
        Stop(pos: 0.00, r: 0.10, g: 0.00, b: 0.35),
        Stop(pos: 0.30, r: 0.55, g: 0.10, b: 0.80),
        Stop(pos: 0.55, r: 0.90, g: 0.20, b: 0.55),
        Stop(pos: 0.80, r: 1.00, g: 0.45, b: 0.10),
        Stop(pos: 1.00, r: 1.00, g: 0.75, b: 0.30),
    ])

    static let all: [Palette] = [.sunset, .ocean, .forest, .cyberpunk, .fire, .twilight]
